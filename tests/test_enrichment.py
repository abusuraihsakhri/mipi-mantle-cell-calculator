"""
Automated Pytest for mipi-mantle-cell-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    MipimantlecellcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = MipimantlecellcalculatorEnrichmentSuite()
