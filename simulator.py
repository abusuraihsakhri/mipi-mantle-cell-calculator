...
def run_simulation(iterations: int = 100):
    print(f"Starting Distributed Component Simulation on Mipi Mantle Cell Calculator ({iterations} tasks)...")
    ...
    print("\n" + "=" * 70)
    print(f"  SIMULATION SUMMARY FOR MIPI MANTLE CELL CALCULATOR")
    print("=" * 70)
